        ...
        content: `
            <div style="display: flex; gap: 20px; align-items: start;">
                <div style="display: flex; flex-direction: column; gap: 12px;">
                    <img src="images/farah-portrait.jpg" style="width: 200px; height: auto; border: 3px solid #000080; box-shadow: 4px 4px 0px rgba(0,0,0,0.3);">
                    <img src="images/profile-sunglass.jpg" style="width: 200px; height: auto; border: 3px solid #ff6b9d; box-shadow: 4px 4px 0px rgba(0,0,0,0.3);">
                </div>
                <div style="flex: 1;">
    ...
    portfolio: {
        ...
        content: `
            <div id="portfolioView">
                <div id="portfolioGrid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px; padding: 12px; max-height: 100%; overflow-y: auto;">
                    <div class="artwork-thumb" onclick="viewArtwork(0)" style="cursor: pointer; border: 3px solid #808080; transition: border-color 0.2s;">
                        <img src="images/mindfully-mind-full.jpg" style="width: 100%; height: 140px; object-fit: cover; display: block;">
                        <div style="padding: 6px; background: #C0C0C0; text-align: center; font-size: 10px; font-weight: bold;">Mindfully, Mind Full</div>
                    </div>
                    <div class="artwork-thumb" onclick="viewArtwork(1)" style="cursor: pointer; border: 3px solid #808080; transition: border-color 0.2s;">
                        <img src="images/ladies-of-lately.jpg" style="width: 100%; height: 140px; object-fit: cover; display: block;">
                        <div style="padding: 6px; background: #C0C0C0; text-align: center; font-size: 10px; font-weight: bold;">Ladies of Lately</div>
                    </div>
                    <div class="artwork-thumb" onclick="viewArtwork(2)" style="cursor: pointer; border: 3px solid #808080; transition: border-color 0.2s;">
                        <img src="images/time-travel.jpg" style="width: 100%; height: 140px; object-fit: cover; display: block;">
                        <div style="padding: 6px; background: #C0C0C0; text-align: center; font-size: 10px; font-weight: bold;">Time Travel</div>
                    </div>
                    <div class="artwork-thumb" onclick="viewArtwork(3)" style="cursor: pointer; border: 3px solid #808080; transition: border-color 0.2s;">
                        <img src="images/unphased.png" style="width: 100%; height: 140px; object-fit: cover; display: block;">
                        <div style="padding: 6px; background: #C0C0C0; text-align: center; font-size: 10px; font-weight: bold;">Unphased</div>
                    </div>
                    <div class="artwork-thumb" onclick="viewArtwork(4)" style="cursor: pointer; border: 3px solid #808080; transition: border-color 0.2s;">
                        <img src="images/drink-and-dance.png" style="width: 100%; height: 140px; object-fit: cover; display: block;">
                        <div style="padding: 6px; background: #C0C0C0; text-align: center; font-size: 10px; font-weight: bold;">A Drink & a Dance</div>
                    </div>
                    <div class="artwork-thumb" onclick="viewArtwork(5)" style="cursor: pointer; border: 3px solid #808080; transition: border-color 0.2s;">
                        <img src="images/night-with-band.png" style="width: 100%; height: 140px; object-fit: cover; display: block;">
                        <div style="padding: 6px; background: #C0C0C0; text-align: center; font-size: 10px; font-weight: bold;">Night with the Band</div>
                    </div>
                    <div class="artwork-thumb" onclick="viewArtwork(6)" style="cursor: pointer; border: 3px solid #808080; transition: border-color 0.2s;">
                        <img src="images/warped-lens-ii.jpg" style="width: 100%; height: 140px; object-fit: cover; display: block;">
                        <div style="padding: 6px; background: #C0C0C0; text-align: center; font-size: 10px; font-weight: bold;">Warped Lens II</div>
                    </div>
                    <div class="artwork-thumb" onclick="viewArtwork(7)" style="cursor: pointer; border: 3px solid #808080; transition: border-color 0.2s;">
                        <img src="images/warped-lens-iii.jpg" style="width: 100%; height: 140px; object-fit: cover; display: block;">
                        <div style="padding: 6px; background: #C0C0C0; text-align: center; font-size: 10px; font-weight: bold;">Warped Lens III</div>
                    </div>
                    <div class="artwork-thumb" onclick="viewArtwork(8)" style="cursor: pointer; border: 3px solid #808080; transition: border-color 0.2s;">
                        <img src="images/boy-meet-bed.jpg" style="width: 100%; height: 140px; object-fit: cover; display: block;">
                        <div style="padding: 6px; background: #C0C0C0; text-align: center; font-size: 10px; font-weight: bold;">Boy Meet Bed</div>
                    </div>
                    <div class="artwork-thumb" onclick="viewArtwork(9)" style="cursor: pointer; border: 3px solid #808080; transition: border-color 0.2s;">
                        <img src="images/embodied-body.jpg" style="width: 100%; height: 140px; object-fit: cover; display: block;">
                        <div style="padding: 6px; background: #C0C0C0; text-align: center; font-size: 10px; font-weight: bold;">Embodied Body</div>
                    </div>
                    <div class="artwork-thumb" onclick="viewArtwork(10)" style="cursor: pointer; border: 3px solid #808080; transition: border-color 0.2s;">
                        <img src="images/lisbon-art.jpg" style="width: 100%; height: 140px; object-fit: cover; display: block;">
                        <div style="padding: 6px; background: #C0C0C0; text-align: center; font-size: 10px; font-weight: bold;">Lisbon</div>
                    </div>
                    <div class="artwork-thumb" onclick="viewArtwork(11)" style="cursor: pointer; border: 3px solid #808080; transition: border-color 0.2s;">
                        <img src="images/bahn-mi.jpg" style="width: 100%; height: 140px; object-fit: cover; display: block;">
                        <div style="padding: 6px; background: #C0C0C0; text-align: center; font-size: 10px; font-weight: bold;">Bahn-mi</div>
                    </div>
                </div>
            </div>
        `
            ...
            <div style="background: linear-gradient(135deg, #667eea, #764ba2); padding: 16px; height: 100%; display: flex; flex-direction: column;">
                <div style="background: #C0C0C0; border: 2px solid; border-color: #ffffff #000000 #000000 #ffffff; padding: 16px; margin-bottom: 16px;">
                    <div style="background: black; color: #ff6b9d; padding: 16px; text-align: center; font-size: 12px; margin-bottom: 12px;">
                        <div style="font-size: 14px; margin-bottom: 8px;">🎙️ Studio Process Recording 2</div>
                        <div style="font-size: 11px; color: #feca57;">Design Digital Art Into Physical Artifacts</div>
                    </div>
                    <audio id="studioAudio" controls style="width: 100%; margin-bottom: 12px;">
                        <source src="images/studio-process.m4a" type="audio/mp4">
                        Your browser does not support the audio element.
                    </audio>
                    <p style="font-size: 10px; color: #666; text-align: center;">
                        Listen to thoughts on transforming digital concepts into tangible art pieces.
                    </p>
                </div>
                
                <div style="background: linear-gradient(135deg, #ff6b9d, #feca57); padding: 16px; border-radius: 8px; margin-bottom: 16px;">
                    <h3 style="font-size: 13px; font-weight: bold; color: white; margin-bottom: 8px;">🎨 About This Recording</h3>
                    <p style="font-size: 11px; color: white; line-height: 1.6;">
                        A candid studio session exploring the journey from digital concepts to physical artifacts—the process, the challenges, and the joy of giving ideas physical form.
                    </p>
                </div>
                
                <div style="background: white; border: 2px solid; border-color: #ffffff #000000 #000000 #ffffff; padding: 8px; flex: 1; overflow: auto;">
                    <div style="font-size: 11px; font-weight: bold; margin-bottom: 8px;">🎧 Studio Playlist Vibes:</div>
                    <div style="padding: 8px; font-size: 11px; cursor: pointer; border-bottom: 1px solid #e0e0e0;">• Late Night Studio Sessions</div>
                    <div style="padding: 8px; font-size: 11px; cursor: pointer; border-bottom: 1px solid #e0e0e0;">• Creative Flow State</div>
                    <div style="padding: 8px; font-size: 11px; cursor: pointer; border-bottom: 1px solid #e0e0e0;">• Color Theory & Jazz</div>
                    <div style="padding: 8px; font-size: 11px; cursor: pointer; border-bottom: 1px solid #e0e0e0;">• Brushstroke Rhythm</div>
                    <div style="padding: 8px; font-size: 11px; cursor: pointer; border-bottom: 1px solid #e0e0e0;">• Full Mind Party Mix</div>
                </div>
            </div>
        `
    },
    ...
    artbook: {
        ...
        content: `
            <div style="padding: 16px; height: 100%; display: flex; flex-direction: column;">
                <div style="background: linear-gradient(135deg, #667eea, #764ba2); padding: 20px; border-radius: 8px; margin-bottom: 16px; color: white;">
                    <h2 style="font-size: 20px; margin-bottom: 8px;">Full Mind Party</h2>
                    <p style="font-size: 12px; opacity: 0.9;">Art Book 2026 - A comprehensive collection</p>
                </div>
                
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; flex: 1;">
                    <div style="background: #C0C0C0; border: 2px solid; border-color: #ffffff #000000 #000000 #ffffff; padding: 16px; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                        <div style="font-size: 48px; margin-bottom: 12px;">📚</div>
                        <h3 style="font-size: 14px; font-weight: bold; margin-bottom: 8px; text-align: center;">2026 Art Book</h3>
                        <p style="font-size: 11px; text-align: center; margin-bottom: 16px; color: #666;">Full collection of recent works</p>
                        <a href="images/art-book-2026.pdf" target="_blank" class="win95-button" style="padding: 8px 16px; text-decoration: none; color: black; font-size: 12px;">📥 View/Download</a>
                    </div>
                    
                    <div style="background: #C0C0C0; border: 2px solid; border-color: #ffffff #000000 #000000 #ffffff; padding: 16px; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                        <div style="font-size: 48px; margin-bottom: 12px;">🤖</div>
                        <h3 style="font-size: 14px; font-weight: bold; margin-bottom: 8px; text-align: center;">AI Naming Journey</h3>
                        <p style="font-size: 11px; text-align: center; margin-bottom: 16px; color: #666;">The Gemini Art Title Spiral</p>
                        <a href="images/ai-naming-journey.pdf" target="_blank" class="win95-button" style="padding: 8px 16px; text-decoration: none; color: black; font-size: 12px;">📥 View/Download</a>
                    </div>
                    
                    <div style="background: #C0C0C0; border: 2px solid; border-color: #ffffff #000000 #000000 #ffffff; padding: 16px; display: flex; flex-direction: column; align-items: center; justify-content: center; grid-column: span 2;">
                        <div style="font-size: 48px; margin-bottom: 12px;">🎨</div>
                        <h3 style="font-size: 14px; font-weight: bold; margin-bottom: 8px; text-align: center;">Giving The Full Mind A Physical Form</h3>
                        <p style="font-size: 11px; text-align: center; margin-bottom: 16px; color: #666;">Essay on transforming digital art into physical artifacts</p>
                        <a href="images/full-mind-physical-form.pdf" target="_blank" class="win95-button" style="padding: 8px 16px; text-decoration: none; color: black; font-size: 12px;">📥 View/Download</a>
                    </div>
                </div>
            </div>
        `
...
const artworkData = [
    ...
    },
    {
        ...
        image: 'images/warped-lens-ii.jpg',
        description: 'Part of the Warped Lens series—exploring perception through distorted perspectives, where reality bends and familiar forms become fluid.'
    },
    {
        title: 'Warped Lens III',
        image: 'images/warped-lens-iii.jpg',
        description: 'The third in the Warped Lens series—continuing the exploration of how we see and are seen, filtered through layers of experience.'
    },
    {
        title: 'Boy Meet Bed',
        image: 'images/boy-meet-bed.jpg',
        description: 'An intimate portrait of vulnerability and rest—capturing the quiet moments between the noise, where the body surrenders to stillness.'
    },
    {
        title: 'Embodied Body',
        image: 'images/embodied-body.jpg',
        description: 'A celebration of physical presence and form—the body as landscape, as home, as the vessel that carries our full minds through the world.'
    },
    {
        title: 'Lisbon',
        image: 'images/lisbon-art.jpg',
        description: 'Inspired by the light and energy of Lisbon—where old world charm collides with contemporary life in vibrant color and texture.'
    },
    {
        title: 'Bahn-mi',
        image: 'images/bahn-mi.jpg',
        description: 'A playful exploration of cultural fusion and everyday beauty—finding art in the moments of nourishment and shared meals.'
    }
];
